...
namespace MathslideLearning.Business.Services
{
    public class UserService : IUserService
    {
        ...
        private string GenerateJwtToken(User user)
        {
            ...
            var token = new JwtSecurityToken(issuer: _configuration["Jwt:Issuer"], audience: _configuration["Jwt:Audience"], claims: claims, expires: DateTime.Now.AddHours(24), signingCredentials: credentials);
