...
{
    /// <inheritdoc />
    public partial class AddEcommerceAndExamFeatures : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserExamHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserExamHistories_Exams_ExamId",
                        column: x => x.ExamId,
                        principalTable: "Exams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserExamHistories_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReceiptDetails", x => new { x.ReceiptId, x.SlideId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReceiptDetails_Slides_SlideId",
                        column: x => x.SlideId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReceiptDetails_SlideId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserExamHistories_ExamId",
                table: "UserExamHistories",
                column: "ExamId");

            migrationBuilder.CreateIndex(
                name: "IX_UserExamHistories_UserId",
                table: "UserExamHistories",
                column: "UserId");
        }
